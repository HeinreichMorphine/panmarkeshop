...
function initializeMockProducts() {
    const products = [
        ...
        },
        {
            ...
            image: "https://via.placeholder.com/300x400/3F4E4F/FFFFFF?text=Leather+Journal",
            sold: 0
        },
        {
            id: 13,
            ...
            image: "https://via.placeholder.com/300x400/3F4E4F/FFFFFF?text=Mechanical+Pencil+Set",
            sold: 0
        },
        {
            id: 14,
            ...
            image: "https://via.placeholder.com/300x400/3F4E4F/FFFFFF?text=Desk+Organizer",
            sold: 0
        },
        {
            id: 15,
            ...
            image: "https://via.placeholder.com/300x400/3F4E4F/FFFFFF?text=Calligraphy+Set",
            sold: 0
        },
        {
            id: 16,
            ...
            image: "https://via.placeholder.com/300x400/3F4E4F/FFFFFF?text=Sticky+Notes+Pack",
            sold: 0
        },
        {
            id: 17,
            ...
            image: "https://via.placeholder.com/300x400/3F4E4F/FFFFFF?text=Paper+Shredder",
            sold: 0
        },
        {
            id: 18,
            ...
            image: "https://via.placeholder.com/300x400/3F4E4F/FFFFFF?text=Whiteboard+Set",
            sold: 0
        },
        {
            id: 19,
            ...
            image: "https://via.placeholder.com/300x400/3F4E4F/FFFFFF?text=File+Cabinet",
            sold: 0
        },
        {
            id: 20,
            ...
            image: "https://via.placeholder.com/300x400/3F4E4F/FFFFFF?text=Laptop+Stand",
            sold: 0
        }
    ];
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                ${cartItems.map(item => `
                    <div class="flex items-center p-6 border-b">
                        <img src="${item.image}" alt="${item.productName}" class="${item.category === 'Books' ? 'w-full aspect-[2/3] object-cover' : 'w-full aspect-[4/3] object-contain'}">
    ...
    return `
        <div>
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    <h3 class="text-xl font-bold text-panmark-dark mb-4">Recent Activity</h3>
                    <p class="text-gray-600">Welcome back, ${currentUser.name}!</p>
                    <p class="text-gray-600 mt-2">You can manage your orders, reviews, and shopping cart from here.</p>
                </div>
            </div>
        </div>
    `;
