                            ...
                            <tbody>
                                ${products.map(product => `
                                    <tr class="border-b hover:bg-gray-50">
                                        <td class="px-2 py-2">
                                            <img src="${product.image}" alt="${product.productName}" class="w-16 h-16 object-contain rounded" />
                                        </td>
                                        <td class="px-2 py-2">
                                            <div>
    ...
    return `
        <div class="max-w-4xl mx-auto">
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <div class="md:flex">
                    <div class="md:w-1/2">
                        <img src="${product.image}" alt="${product.productName}" class="w-full max-h-96 object-contain bg-white">
                    </div>
                    <div class="md:w-1/2 p-6">
                        ...
                        <div class="flex justify-between mt-8">
                            <button ${prevProduct ? `onclick=\"navigateTo('product-details?id=${prevProduct.id}')\"` : 'disabled'} class="px-4 py-2 rounded bg-gray-200 text-gray-700 hover:bg-gray-300 disabled:opacity-50">&larr; Previous</button>
                            <button ${nextProduct ? `onclick=\"navigateTo('product-details?id=${nextProduct.id}')\"` : 'disabled'} class="px-4 py-2 rounded bg-gray-200 text-gray-700 hover:bg-gray-300 disabled:opacity-50">Next &rarr;</button>
                        </div>
                    </div>
                </div>
...
function getCartPageContent() {
    ...
    if (currentUser.role === 'admin') {
        // Admin Cart Page - Not applicable, redirect to admin dashboard
        return `
            <div class="text-center">
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                ${cartItems.map(item => `
                    <div class="flex items-center p-6 border-b">
                        <img src="${item.image}" alt="${item.productName}" class="${item.category === 'Books' ? 'w-full aspect-[2/3] object-cover' : 'w-full aspect-square object-cover'}">
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6">
                        <div class="flex justify-between items-start mb-4">
                            ...
                            <div class="text-right">
                                ...
                                ${currentUser.role === 'admin' ? `
                                    <div class="mt-2">
                                        <select onchange="changeOrderStatus(${order.id}, this.value)" class="border border-gray-300 rounded px-2 py-1">
        ...
        <div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6 mb-8">
                ...
                <div class="space-y-3">
                    ...
                    <a href="#" onclick="navigateTo('admin-dashboard')" class="block bg-gray-600 text-white px-4 py-3 rounded-md hover:bg-opacity-90 transition-colors text-center">
                        Admin Panel
                    </a>
