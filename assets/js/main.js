...
function initializeMockProducts() {
    const products = [
        ...
        // Stationery Category
        {
            ...
            price: 3.40,
            stock: 100,
            description: "Assorted ballpoint pens, pack of 4.",
        ...
        },
        {
            ...
            price: 7.50,
            stock: 80,
            description: "Premium HB pencils, set of 12.",
        ...
        },
        {
            ...
            price: 1.05,
            stock: 100,
            description: "High-quality eraser, single piece.",
        ...
        },
        {
            ...
            price: 12.00,
            stock: 60,
            description: "B6 beige wirebound notebook, 80 plain sheets.",
            image: "assets/images/stationery/notebook.jpg",
            sold: 0
        },
        {
            id: 15,
            productName: "Plastic Ruler",
            category: "Stationery",
            price: 0.80,
            stock: 70,
            description: "High class plastic straight ruler, 15cm (6 inch).",
        ...
        },
        {
            ...
            price: 3.50,
            stock: 50,
            description: "Stabilo Boss Original Highlighter Pen, assorted colors.",
        ...
        },
        {
            ...
            price: 4.00,
            stock: 40,
            description: "Artline 500A medium whiteboard marker, assorted colors.",
        ...
        },
        {
            ...
            price: 3.60,
            stock: 30,
            description: "Astar HD10 stapler, compact and durable.",
        ...
        },
        {
            ...
            price: 2.00,
            stock: 100,
            description: "Max Staples No.3-1M, box of 1000 staples.",
        ...
        },
        {
            ...
            price: 16.49,
            stock: 120,
            description: "A4 Paper IK Yellows 80gsm, 500 sheets per ream.",
        ...
        },
        {
            ...
            price: 7.90,
            stock: 90,
            description: "3M Post-it Super Sticky Notes, multi-pad, 3x3 inch.",
        ...
        <div class="max-w-4xl mx-auto">
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                    ...
                    <div class="md:w-1/2 p-6">
                        ...
                        <div class="flex space-x-4 mb-6">
                            <input type="number" id="quantity" value="1" min="1" max="${product.stock}" 
                                   class="w-20 px-3 py-2 border border-gray-300 rounded-md ${isAdmin ? 'bg-gray-100 cursor-not-allowed' : ''}" ${product.stock <= 0 || isAdmin ? 'disabled' : ''}>
                            <button onclick="${isAdmin ? '' : `addToCart(${product.id}, parseInt(document.getElementById('quantity').value))`}" 
                                    class="${product.stock <= 0 || isAdmin ? 'bg-gray-400 cursor-not-allowed' : 'bg-panmark-accent hover:bg-opacity-90'} text-white px-6 py-2 rounded-md transition-colors" ${product.stock <= 0 || isAdmin ? 'disabled' : ''}>
                ...
                <div class="p-6 border-t">
                    ...
                    ` : isAdmin ? `<div class='mt-6'><em class='text-gray-400'>Admins cannot submit reviews.</em></div>` : ''}
                </div>
            </div>
        </div>
    `;
