            ...
            <div class="space-y-8">
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-panmark-accent mb-2">Account Access</h3>
                            <p class="text-gray-600">Use your registered username and password to access your account. For demonstration purposes, you may use the following credentials: <strong>john_doe / password123</strong></p>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="space-y-4">
                    <div class="flex items-start space-x-3">
                        <div class="text-panmark-accent text-xl">📞</div>
                        <div>
